...
export function CrisisSidebar({
  ...
  return (
    <div
      id="crisis-sidebar"
      className="fixed top-20 right-6 w-[380px] max-h-[calc(100vh-7.5rem)] bg-[#0c0e12]/90 backdrop-blur-xl border border-white/10 rounded-2xl flex flex-col z-40 overflow-hidden shadow-2xl animate-in slide-in-from-right-4 duration-300 pointer-events-auto"
    >
      {/* Header */}
      <div className="flex items-start justify-between p-4 border-b border-white/10 bg-slate-950/40">
